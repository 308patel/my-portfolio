...
//     description: [
//       "Developed and maintained backend services using Node.js and NestJS, delivering scalable and high-performance APIs across diverse applications.",
//       "Designed and optimized PostgreSQL database schemas and queries to ensure efficient data management and system reliability.",
//       "Contributed to a CRM project, implementing core modules and backend logic to streamline business operations and improve overall efficiency.",
//     ],
//   },
//   {
